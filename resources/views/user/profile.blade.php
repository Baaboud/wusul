...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">الملف الشخصي /</span> Profile
        </h4>
                ...
                <div class="card mb-4">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <img src="{{ asset('img/user.png') }}" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
                        </div>
                                ...
                                <div class="user-profile-info">
                                    ...
                                    <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                        <li class="list-inline-item fw-semibold">
                                            <i class="bx bx-pen"></i> مطور ويب
                                        </li>
                                        <li class="list-inline-item fw-semibold">
                                            <i class="bx bx-map"></i> حضرموت-المكلا
                                        </li>
                                        <li class="list-inline-item fw-semibold">
                                            <i class="bx bx-calendar-alt"></i> انضم في April 2021
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    ...
                    <li class="nav-item"><a class="nav-link" href="pages-profile-projects.html"><i class="bx bx-grid-alt"></i> الاعمال</a></li>
                    <li class="nav-item"><a class="nav-link" href="pages-profile-connections.html"><i class="bx bx-link-alt"></i> الطلبات</a></li>
                </ul>
            </div>
        </div>
        <!--/ Navbar pills -->
